---
title: "Cloc"
date: 2021-07-22T15:11:49+08:00
draft: false
---
...
Usage: cloc [options] <file(s)/dir(s)/git hash(es)> | <set 1> <set 2> | <report files>
 ...
 Input Options
   --extract-with=<cmd>      This option is only needed if cloc is unable
                             ...
                             and on Windows use, for example:
                               --extract-with="\"c:\Program Files\WinZip\WinZip32.exe\" -e -o >FILE< ."                             (if WinZip is installed there).
 ...
 Processing Options
   ...
   --config <file>           Read command line switches from <file> instead of
                             the default location of /c/Users/v_guancli/.config/cloc/options.txt.      
                             ...
                             take priority over /c/Users/v_guancli/.config/cloc/options.txt.
